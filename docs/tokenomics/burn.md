ShotSpec Token Burn Model  
Deflation Mechanics Across CLUB-Native, Fiat-Cost, and Reward Flows
...
The burn model serves the following functions:

• Reduce CLUB circulating supply as usage increases  
...
CLUB-native product purchases:
• 20% of incoming CLUB is burned  
• 80% goes to treasury for development and liquidity

Fiat-cost product purchases paid in CLUB:
• 20% of CLUB burned before or after swap  
• 80% swapped to USDC via Jupiter and used for USD settlement

Anti-cheat automatic deductions:
• Anywhere from 5% to 100% depending on violation severity  
• Tokens sent to a protocol burn address
