ShotSpec DAO Governance  
Token-Weighted, Time-Locked Voting for Long-Term Stability
...
Voting power = tokens staked × lock-duration multiplier
...
• Reward pool emissions  
• Burn percentages  
• Device tier multipliers  
• Anti-cheat policy levels  
• Course partnerships and subsidy programs  
• Treasury management  
• Buyback schedules  
...
• 80% of CLUB-native product payments  
...
DAO-approved enforcement mechanisms include:
