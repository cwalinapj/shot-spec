ShotSpec Mining Nodes  
Neural Node, Lite Node, and Device-Based Token Earnings
...
• 23 TOPS or 26 TOPS accelerator  
• Stereo impact cameras  
• Optional front-facing flight camera  
• Microphone + speaker (Caddie AI)  
• Highest earning tier

Lite Node  
• Low-cost camera device  
• Attaches to golf cart or tripod  
• Captures DTL or face-on angles  
• Medium reward tier
