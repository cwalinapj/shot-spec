ShotSpec Reward Pools and Multipliers  
Dynamic Emission Engine Based on Data Scarcity
...
The reward pool is divided across:

• Impact data  
• Club-attribution data  
• GPS + lie data  
• Multi-angle puts  
...
Multipliers stack in the following categories:
...
• Dual-impact stereo  
• Phone DTL angle  
• Radar pairing (Mevo/Nova/etc.)

Environment-Based:
• Wind over 35 mph  
• Snowing  
• Temperature extremes  
• Night play (if allowed)
...
Multipliers are multiplicative unless flagged as “exclusive.”  
Exclusive examples:
