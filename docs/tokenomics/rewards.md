ShotSpec Rewards Engine  
How Users Earn CLUB Across Devices, Courses, and Data Types
...
Players and devices earn CLUB for:

• Verified golf shots  
• Valid golf rounds  
• Bag completion events  
• Impact video submissions  
• Multi-angle data (stereo + phone)  
• Rare environmental conditions (wind, rain, temperature extremes)  
...
Pending rewards protect the system from:
...
The daily reward amount is dynamic:
...
When the neural network becomes world-class:
